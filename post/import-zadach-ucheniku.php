...
$SqlQuery = "INSERT IGNORE INTO `uchenik-voprosy` (`id-voprosa`, `uchenik`, `predmet`) SELECT `voprosy`.`id-voprosa`, '".$sUchenik."', '".$sPredmet."' FROM `voprosy` WHERE `voprosy`.`predmet` = '".$sPredmet."';";
//выполним запрос
$res = $mysqli->query($SqlQuery);
//отладочные строки
//echo $SqlQuery;
