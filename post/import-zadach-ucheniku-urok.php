...
$SqlQuery = "INSERT IGNORE INTO `uchenik-zadachi` (`id-zadachi`, `urok`, `uchenik`, `predmet`, `aktualno`) SELECT `zadacha`.`id-zadachi`, `zadacha`.`urok`, '".$sUchenik."', '".$sPredmet."', 1 FROM `zadacha` WHERE `zadacha`.`predmet` = '".$sPredmet."' AND `zadacha`.`urok`=1 AND `zadacha`.`zadanie` = ".$iZadanie.";";
//выполним запрос
