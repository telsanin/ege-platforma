...
$SqlQuery = "SELECT IF((`resheno-pravilno`=1) OR (`reshali-na-zanyatii`=1),1,0) AS rp, `uchenik-zadachi`.urok, count(`uchenik-zadachi`.urok) as count FROM `uchenik-zadachi`, zadacha WHERE `zadacha`.`id-zadachi`=`uchenik-zadachi`.`id-zadachi` and uchenik='".$sUchenik."' and `uchenik-zadachi`.predmet='".$sPredmet."' and zadanie=".$iZadanie." group by rp, `uchenik-zadachi`.urok;";
//выполним запрос
